...
class Device:
  ...
  thrift_spec = (
    ...
    (6, TType.LIST, 'functionality', (TType.BOOL,None), None, ), # 6
      ...
      if fid == 1:
        ...
        if ftype == TType.LIST:
          ...
          for _i4 in xrange(_size0):
            ...
            self.functionality.append(_elem5)
          iprot.readListEnd()
        else:
          iprot.skip(ftype)
      elif fid == 7:
  ...
  def write(self, oprot):
    ...
    if self.functionality is not None:
      oprot.writeFieldBegin('functionality', TType.LIST, 6)
      oprot.writeListBegin(TType.BOOL, len(self.functionality))
      for iter6 in self.functionality:
  ...
  def __hash__(self):
    ...
    value = (value * 31) ^ hash(self.functionality)
...
class UserProfile:
  ...
  def __hash__(self):
    ...
    value = (value * 31) ^ hash(self.devices)
    return value
